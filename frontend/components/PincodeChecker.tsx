...
export default function PincodeChecker({ onResult, initialPincode, value, onChange }: PincodeCheckerProps) {
  const [internalPincode, setInternalPincode] = useState(initialPincode || '');
  const pincode = value !== undefined ? value : internalPincode;
